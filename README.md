...
## 📸 Screenshots
À intégrer dans ton repo :  

```
assets/screenshots/home_light.png
assets/screenshots/home_dark.png
assets/screenshots/todo_form.png
assets/screenshots/settings.png
assets/screenshots/sign_in.png
```
...
Le projet respecte **toutes les consignes EFREI** :  
Firebase Auth, CRUD Todo, Provider, GoRouter, UI Material3, thème persistant, architecture claire et modulaire.

Il va même plus loin que le niveau attendu.
